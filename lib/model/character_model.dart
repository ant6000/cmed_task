...
List<Characterslist> charactersFromJson(String str) =>
    List<Characterslist>.from(json.decode(str).map((x) => Characterslist.fromJson(x)));

String charactersToJson(List<Characterslist> data) =>
